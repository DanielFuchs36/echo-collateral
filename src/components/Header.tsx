        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
            <div className="vault-panel p-3 rounded-lg">
              <Radio className="h-8 w-8 text-accent animate-pulse-glow" />
            </div>
            <div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/vault" className="text-muted-foreground hover:text-accent transition-colors">
              My Vault
            </Link>
            <Link to="/collateralize" className="text-muted-foreground hover:text-accent transition-colors">
              Collateralize
            </Link>
            <Link to="/docs" className="text-muted-foreground hover:text-accent transition-colors">
              Docs
            </Link>
          </nav>
